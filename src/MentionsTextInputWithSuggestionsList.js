...
export default class MentionsTextInputWithSuggestionsList extends Component {
  constructor() {
    super();
    this.state = {
      textInputHeight: "",
...
MentionsTextInputWithSuggestionsList.propTypes = {
...
MentionsTextInputWithSuggestionsList.defaultProps = {
